...
- Se agregó evento onTogglePrefab que se envía con la struct ObjectData que contiene el nombre del objeto a activar/desactivar. Reciben Player House y Environment prefabs. 
- Se agregó evento onCheckpointEventReached que es llamado desde el EventsHandler al comenzar un evento que sea checkpoint. Escucha Data Persistence Manager para guardar, y el futuro canvas que muestra el logo de guardando.
...
- Crear canvas de guardado con logo del juego y texto de guardado. (Saving Canvas).
