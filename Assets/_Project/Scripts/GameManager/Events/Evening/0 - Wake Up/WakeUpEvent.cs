namespace TwelveG.GameManager
{
    ...
    public class WakeUpEvent : GameEventBase
    {
        ...
        [SerializeField] private EventsObservationsTextsSO eventsObservationsTextsSO;
        ...
        public override IEnumerator Execute()
        {
            ...
            onObservationCanvasShowText.Raise(
                this,
                Utils.TextFunctions.RetrieveEventObservationText(
                    GetComponentInParent<LocalizationData>().CurrentLanguage,
                    eventObservationTextIndex,
                    eventsObservationsTextsSO
                )
            );
            ...
            onInteractionCanvasShowText.Raise(
                this,
