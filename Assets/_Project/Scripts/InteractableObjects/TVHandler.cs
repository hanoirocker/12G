namespace TwelveG.PlayerController
{
    ...
    public class TVHandler : MonoBehaviour
    {
        ...
        [SerializeField] ItemControlTextSO itemControlText;
        [SerializeField] List<GameEventListener> eventListenersToToggle;

        [Header("Interaction options")]
        [TextArea(2, 5)]
        [SerializeField] private string interactionOptions;

        [Header("EventsSO references")]
        public GameEventSO onControlCanvasSetInteractingOptions;
        ...
        private void PlayerState(bool playerStateOfInteraction)
        {
            ...
            if (playerIsInteracting)
            {
                onControlCanvasSetInteractingOptions.Raise(this, itemControlText.text);
            }
            else
            {
                onControlCanvasSetInteractionOptions.Raise(this, interactionOptions);
            }
        }
