namespace TwelveG.PlayerController
{
    ...
    public class PlayerInteraction : MonoBehaviour
    {
                ...
                if (objectHasInteractableComponent && interactObj.CanBeInteractedWith(this))
                {
                    ...
                    if (Input.GetKeyDown(KeyCode.E))
                    {
                        ...
                        else
                        {
                            ...
                            StartCoroutine(CancelInteractionAndShowObservation(interactObj, hitInfo.collider, localizationData.CurrentLanguage));
                        }
                    }
                }
            }
        ...
        private IEnumerator CancelInteractionAndShowObservation(IInteractable interactObj, Collider collider, string languageCode)
        {
            // TODO: move observation from text to SO!
            string observationText = interactObj.GetFallBackText(languageCode);
